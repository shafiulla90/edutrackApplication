...
const firebaseConfig = {
  ...
  storageBucket: process.env.NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET || 'edutrack-52e6c.appspot.com',
  ...
  measurementId: process.env.NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID || 'G-6S7K2Z6K3M',
};
