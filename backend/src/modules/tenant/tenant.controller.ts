import { Controller, Get, Post, Put, Body, Headers, Param, Request } from '@nestjs/common';
...
export class TenantController {
  ...
  async getSetupStatus(@Request() req: any, @Headers('X-Tenant-ID') headerTenantId?: string) {
    const tenantId = req?.user?.tenantId || req?.tenantId || headerTenantId;
