export interface IStudentRepository {
  ...
  findStudentsByClassSection(classSectionId: string, tenantId?: string): Promise<any[]>;
  ...
  findStudentsByParent?(parentIdentifier: string, tenantId: string, userObj?: any): Promise<any[]>;
}
